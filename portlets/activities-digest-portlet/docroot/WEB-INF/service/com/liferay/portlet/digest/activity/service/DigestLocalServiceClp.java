 ...
 */
public class DigestLocalServiceClp implements DigestLocalService {
	public DigestLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName3 = "processInactiveUsers";

		_methodParameterTypes3 = new String[] { "long", "int" };

		_methodName4 = "processUsers";
	...
	public void processInactiveUsers(long companyId, int frequency)
		...
		try {
			_invokableLocalService.invokeMethod(_methodName3,
				_methodParameterTypes3, new Object[] { companyId, frequency });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void processUsers(long companyId, int frequency)
		...
		try {
			_invokableLocalService.invokeMethod(_methodName4,
				_methodParameterTypes4, new Object[] { companyId, frequency });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
