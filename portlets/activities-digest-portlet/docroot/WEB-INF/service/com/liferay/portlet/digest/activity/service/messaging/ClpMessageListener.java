...
package com.liferay.portlet.digest.activity.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			DigestLocalServiceUtil.clearService();

			DigestConfigurationLocalServiceUtil.clearService();

			UserDigestConfigurationLocalServiceUtil.clearService();
		}
	}
}